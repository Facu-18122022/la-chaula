...
(function (global) {
    ...
    const MAPAS = [
        ...
        { name: 'Neon Cyberpunk (2v2)', width: 900, height: 450, fieldColor: '#170b24', lineColor: '#00ffcc', goalHeight: 120, bg: '#090514', goalBg: '#2a0a4a', theme: 'cyberpunk' },
        { name: 'Micro Arena (1v1)', width: 500, height: 300, fieldColor: '#6e2c00', lineColor: '#f1c40f', goalHeight: 150, bg: '#421a00', goalBg: '#935116', theme: 'micro' },
        { name: 'Titan Colosseum (8v8)', width: 1600, height: 800, fieldColor: '#4a235a', lineColor: '#f5b041', goalHeight: 250, bg: '#290e36', goalBg: '#6c3483', theme: 'titan' },
        { name: 'The Tunnel (3v3)', width: 1200, height: 350, fieldColor: '#1e8449', lineColor: '#aed6f1', goalHeight: 120, bg: '#145a32', goalBg: '#27ae60', theme: 'tunnel' },
        { name: 'Volcanic Crater (4v4)', width: 1100, height: 550, fieldColor: '#641e16', lineColor: '#e74c3c', goalHeight: 160, bg: '#1b0a0a', goalBg: '#922b21', theme: 'volcanic' }
    ];
